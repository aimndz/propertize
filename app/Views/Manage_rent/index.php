        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative rounded-lg shadow bg-primary-900 border border-accent-800">
                ...
                <div class="p-4 md:p-5 text-center">
                    <h1 class="text-primary-100 font-bold text-xl mb-4 mt-5">Become a Landlord?</h1>
                    <p class="text-primary-100 text-center mb-4">Are you interested in becoming a landlord and having your own landlord dashboard?</p>

                    <div class="flex justify-center gap-1">

                        <a href="mode-of-payment">
                            <form action="/update_landlord_role">
...
<section class="max-w-screen-xl mx-auto text-center mt-60 px-4 ">
    ...
    <?php if ($showLandlordModal) : ?>
        <a href="#" data-modal-target="seller-modal" data-modal-toggle="seller-modal"><button class="block font-bold bg-primary-900 px-8 py-3 md:py-5 md:px-16 rounded-full mx-auto text-sm md:text-base hover:bg-accent-800 whitespace-nowrap border text-primary-100">Manage Rents Now!</button></a>
        <!-- <a href="/list-property"><button class="block font-bold bg-primary-900 px-8 py-3 md:py-5 md:px-16 rounded-full mx-auto text-sm md:text-base hover:bg-accent-800 whitespace-nowrap border text-primary-100">Manage Rents Now!</button></a> -->
    <?php else : ?>
        <a href="/list-rent"><button class="block font-bold bg-primary-900 px-8 py-3 md:py-5 md:px-16 rounded-full mx-auto text-sm md:text-base hover:bg-accent-800 whitespace-nowrap border text-primary-100">Manage Rents Now!</button></a>
    <?php endif; ?>
</section>
