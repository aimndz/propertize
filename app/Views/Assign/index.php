    ...
    <div class="relative p-4 w-full max-w-3xl max-h-full">
        ...
        <div class="relative rounded-lg bg-accent-900 border border-accent-800 shadow-custom p-10">
            ...
            <div class="flex flex-col px-4 md:px-5 md:pt-5 pt-4 rounded-t dark:border-gray-600">
                ...
                <p class="text-white/50 text-center mt-5 text-sm"><span class="font-bold ft">Note:</span> Please ensure all details are correct before assigning a tenant to a property.</p>
            </div>
            <!-- Modal body -->
            <div class="p-4 md:p-5">
                <?= form_open('/perform-assign/' . $propertyId) ?>
                ...
                <div class="flex justify-center mt-4">
                    <button type="submit" class="rounded-lg bg-primary-500 hover:bg-primary-700 text-primary-900 text-center font-medium px-5 py-2.5">Assign</button>
                </div>
                <?= form_close() ?>
            </div>
