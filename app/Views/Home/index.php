    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative rounded-lg shadow bg-primary-900">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="#" novalidate group>
                    <div class="relative">
                        <input type="email" id="login-username" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent  disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-900 dark:border-neutral-700 dark:text-primary-100 dark:focus:ring-primary-100
                    ...
                    <div class="relative">
                        <input type="password" id="login-password" class="passwordInput peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent  disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-900 dark:border-neutral-700 dark:text-primary-100 dark:focus:ring-primary-100
                        ...
                        <button class="togglePasswordButton absolute top-1/2 end-4 -translate-y-1/2 transform focus:outline-none hover:text-primary-200 dark:hover:text-primary-200 aria-label='Toggle Password Visibility'">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative rounded-lg shadow bg-primary-900">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="#" novalidate group>
                    <div class="relative">
                        <input type="text" id="sign-up-first-name" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent  disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-900 dark:border-neutral-700 dark:text-primary-100 dark:focus:ring-primary-100
                                focus:pt-6
                                focus:pb-2
                    ...
                    <div class="relative">
                        <input type="text" id="sign-up-last-name" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent  disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-900 dark:border-neutral-700 dark:text-primary-100 dark:focus:ring-primary-100
                                focus:pt-6
                                focus:pb-2
                                [&:not(:placeholder-shown)]:pt-6
                                [&:not(:placeholder-shown)]:pb-2
                    ...
                    <div class="relative">
                        <input type="text" id="sign-up-user-name" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent  disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-900 dark:border-neutral-700 dark:text-primary-100 dark:focus:ring-primary-100
                                focus:pt-6
                                focus:pb-2
                                [&:not(:placeholder-shown)]:pt-6
                                [&:not(:placeholder-shown)]:pb-2
                    ...
                    <div class="relative">
                        <input type="email" id="sign-up-email" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent  disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-900 dark:border-neutral-700 dark:text-primary-100 dark:focus:ring-primary-100
                                focus:pt-6
                                focus:pb-2
                                [&:not(:placeholder-shown)]:pt-6
                                [&:not(:placeholder-shown)]:pb-2
                    ...
                    <div class="relative">
                        <input type="password" id="sign-up-password" class="passwordInput peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent  disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-900 dark:border-neutral-700 dark:text-primary-100 dark:focus:ring-primary-100
                                focus:pt-6
                                focus:pb-2
                                [&:not(:placeholder-shown)]:pt-6
                                [&:not(:placeholder-shown)]:pb-2
                    ...
                    <div class="relative">
                        <input type="password" id="sign-up-confirm-password" class="passwordInput peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent  disabled:opacity-50 disabled:pointer-events-none dark:bg-accent-900 dark:border-neutral-700 dark:text-primary-100 dark:focus:ring-primary-100
                                focus:pt-6
                                focus:pb-2
                                [&:not(:placeholder-shown)]:pt-6
                                [&:not(:placeholder-shown)]:pb-2
...
<section class="max-w-screen-xl mx-auto text-center mt-40 md:mt-60 px-4">
    <div class="mb-5 md:mb-10">
        <p class="font-bold bg-primary-900 text-primary-100 text-4xl md:text-6xl lg:text-7xl leading-none tracking-tight">
            Your <span class="text-primary-500">Property,</span>
        </p>
        <p class="font-bold bg-primary-900 text-primary-100 text-4xl md:text-6xl lg:text-7xl leading-none tracking-tight">
            We <span class="text-primary-500">Prioritize</span>
        </p>
    </div>
...
<section class="max-w-screen-xl mx-auto mt-10 md:mt-28 px-4 rounded-xl">
    <div class="flex flex-row items-center justify-center space-y-4 mb-10 md:mb-20">
        <div class="w-4 h-4 rounded-full bg-primary-500 hidden md:block"></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-5 md:gap-8">
        <div class="text-primary-100 bg-accent-900 rounded-3xl p-6 md:p-5 lg:p-10 border border-accent-800 shadow-custom">
            <h2 class="font-bold text-2xl md:text-3xl lg:text-5xl mb-4 md:mb-8">Buy</h2>
            ...
            <button class="block font-bold bg-accent-700 px-8 py-3 md:py-5 md:px-16 rounded-full mx-auto text-sm md:text-base hover:bg-accent-800 whitespace-nowrap">Buy a Home</button>
        </div>

        <div class="text-primary-100 bg-accent-900 rounded-3xl p-6 md:p-5 lg:p-10 border border-accent-800 shadow-custom">
            <h2 class="font-bold text-2xl md:text-3xl lg:text-5xl mb-4 md:mb-8">Sell</h2>
            ...
            <button class="block font-bold bg-accent-700 px-8 py-3  md:py-5 md:px-16  rounded-full mx-auto text-sm md:text-base hover:bg-accent-800 whitespace-nowrap">Sell a Home</button>
        </div>

        <div class="text-primary-100 bg-accent-900 rounded-3xl p-6 md:p-5 lg:p-10 border border-accent-800 shadow-custom">
            <h2 class="font-bold text-2xl md:text-3xl lg:text-5xl mb-4 md:mb-8">Rent</h2>
            ...
            <button class="block font-bold bg-accent-700 px-8 py-3 md:py-5 md:px-16  rounded-full mx-auto text-sm md:text-base hover:bg-accent-800 whitespace-nowrap">Rent a Home</button>
        </div>
    </div>
</section>
